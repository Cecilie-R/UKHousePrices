...
## Calculations
The following code creates a function that loops through the monthly created .RDS files and calculates averages for all cominations of conditions that the user will be able to select. Each table of averages is saved in a new RDS .file
```{r}
files<-list.files()
...
names(aggData)<-c("type", "newbuild", "duration", "average", "median", "number")  
